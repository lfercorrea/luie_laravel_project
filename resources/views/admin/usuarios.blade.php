...
@section('content')
    ...
    <div id="confirm-delete-modal" class="modal">
        <div class="modal-content">
            ...
            <p>Tem certeza que deseja excluir este usuário? <span class="red-text">Ao excluí-lo, todos os produtos cadastrados ou alterados por ele serão excluídos em cadeia</span>.</p>
        </div>
