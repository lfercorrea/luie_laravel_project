...
class SiteconfigController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('Iniciando validação de campos (SiteconfigController@store)');
        ...
        Log::info('Validação de campos concluída (SiteconfigController@store)');
        ...
        Log::info('Configurações salvas. (SiteconfigController@store)');
